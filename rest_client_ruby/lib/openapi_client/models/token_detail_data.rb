...
module OpenapiClient
  class TokenDetailData
    ...
    attr_accessor :data_valid_until_timestamp
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'data_valid_until_timestamp')
        self.data_valid_until_timestamp = attributes[:'data_valid_until_timestamp']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          data_valid_until_timestamp == o.data_valid_until_timestamp &&
    ...
    def hash
      [token_number, expiry_month, expiry_year, data_valid_until_timestamp, payment_account_reference].hash
    end
