...
module SwaggerClient
  class TokenDetailData
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tokenNumber')
        self.token_number = attributes[:'tokenNumber']
      end
      ...
      if attributes.has_key?(:'dataValidUntilTimestamp')
        self.data_valid_until_timestamp = attributes[:'dataValidUntilTimestamp']
      end
