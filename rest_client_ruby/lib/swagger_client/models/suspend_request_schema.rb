...
module SwaggerClient
  class SuspendRequestSchema
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'tokenUniqueReferences')
        if (value = attributes[:'tokenUniqueReferences']).is_a?(Array)
          self.token_unique_references = value
        end
      end

      if attributes.has_key?(:'causedBy')
        self.caused_by = attributes[:'causedBy']
      end
