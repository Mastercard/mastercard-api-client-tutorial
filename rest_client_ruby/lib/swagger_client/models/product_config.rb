...
module SwaggerClient
  class ProductConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'customerServiceUrl')
        self.customer_service_url = attributes[:'customerServiceUrl']
      end

      if attributes.has_key?(:'customerServiceEmail')
        self.customer_service_email = attributes[:'customerServiceEmail']
      end
      ...
      if attributes.has_key?(:'issuerMobileApp')
        self.issuer_mobile_app = attributes[:'issuerMobileApp']
      end

      if attributes.has_key?(:'onlineBankingLoginUrl')
        self.online_banking_login_url = attributes[:'onlineBankingLoginUrl']
      end

      if attributes.has_key?(:'termsAndConditionsUrl')
        self.terms_and_conditions_url = attributes[:'termsAndConditionsUrl']
      end
      ...
      if attributes.has_key?(:'issuerProductConfigCode')
        self.issuer_product_config_code = attributes[:'issuerProductConfigCode']
      end
    end
