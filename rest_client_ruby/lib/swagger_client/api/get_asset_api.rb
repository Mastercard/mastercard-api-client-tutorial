...
module SwaggerClient
  class GetAssetApi
    ...
    # @param asset_id An Asset ID corresponds to an individual Digital Asset. Digital Assets are returned as part of the Product Configuration from the Tokenize Response. The Asset ID itself is supplied as a Get request in the form of https://{INSERT ENVIRONMENT URL HERE}/mdes/assets/static/1/0/asset/{AssetID} - See JSON examples for details.  
    # @param [Hash] opts the optional parameters
    # @return [Array<(AssetResponseSchema, Fixnum, Hash)>] AssetResponseSchema data, response status code and response headers
    def get_asset_with_http_info(asset_id, opts = {})
      ...
      # resource path
      local_var_path = '/assets/static/1/0/asset/{AssetId}'.sub('{' + 'AssetId' + '}', asset_id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'AssetResponseSchema')
      if @api_client.config.debugging
