...
module SwaggerClient
  class SearchTokensApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [SearchTokensRequestSchema] :search_tokens_request_schema Contains the details of the request message. 
    # @return [Array<(SearchTokensResponseSchema, Fixnum, Hash)>] SearchTokensResponseSchema data, response status code and response headers
    def search_tokens_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'search_tokens_request_schema'])
      auth_names = []
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'SearchTokensResponseSchema')
      if @api_client.config.debugging
