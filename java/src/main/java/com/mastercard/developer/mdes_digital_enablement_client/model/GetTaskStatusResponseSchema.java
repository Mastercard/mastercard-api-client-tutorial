...
public class GetTaskStatusResponseSchema {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "FAILED", value = "The status of the specified task. Must be either 'PENDING' (The Task has been recieved and is pending processing), 'IN_PROGRESS' (The task is currently in progress), 'COMPLETED' (The task was completed successfully) or 'FAILED' The task was processed but failed to complete successfully. ")
