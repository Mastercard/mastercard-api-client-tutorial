...
public class GetTaskStatusResponseSchema {
  ...
  public GetTaskStatusResponseSchema() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetTaskStatusResponseSchema
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTaskStatusResponseSchema.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTaskStatusResponseSchema is not found in the empty JSON string", GetTaskStatusResponseSchema.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTaskStatusResponseSchema.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTaskStatusResponseSchema` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTaskStatusResponseSchema.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTaskStatusResponseSchema' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTaskStatusResponseSchema> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTaskStatusResponseSchema.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTaskStatusResponseSchema>() {
           @Override
           public void write(JsonWriter out, GetTaskStatusResponseSchema value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTaskStatusResponseSchema read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetTaskStatusResponseSchema given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetTaskStatusResponseSchema
  * @throws IOException if the JSON string is invalid with respect to GetTaskStatusResponseSchema
  */
  public static GetTaskStatusResponseSchema fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTaskStatusResponseSchema.class);
  }

 /**
  * Convert an instance of GetTaskStatusResponseSchema to an JSON string
  *
  * @return JSON string
  */
