...
public class UnSuspendRequestSchema {
  ...
  **/
   ...
   * @return causedBy
  **/
  @ApiModelProperty(example = "CARDHOLDER", required = true, value = "Who or what caused the Token to be unsuspended. Must be either the 'CARDHOLDER' (operation requested by the Cardholder) or 'TOKEN_REQUESTOR' (operation requested by the token requestor). ")
  ...
  **/
   ...
   * @return reasonCode
  **/
  @ApiModelProperty(example = "SUSPECTED_FRAUD", required = true, value = "The reason for the action to be unsuspended. Must be one of 'SUSPECTED_FRAUD' (suspected fraudulent token transactions), 'OTHER' (Other - default used if value not provided). ")
