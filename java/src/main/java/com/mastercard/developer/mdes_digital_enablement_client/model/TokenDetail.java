...
public class TokenDetail {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TokenDetail
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TokenDetail is not found in the empty JSON string", TokenDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TokenDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TokenDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("encryptedData") != null && !jsonObj.get("encryptedData").isJsonNull()) {
        TokenDetailData.validateJsonElement(jsonObj.get("encryptedData"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TokenDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TokenDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TokenDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TokenDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<TokenDetail>() {
           @Override
           public void write(JsonWriter out, TokenDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TokenDetail read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TokenDetail given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TokenDetail
  * @throws IOException if the JSON string is invalid with respect to TokenDetail
  */
  public static TokenDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TokenDetail.class);
  }

 /**
  * Convert an instance of TokenDetail to an JSON string
  *
  * @return JSON string
  */
