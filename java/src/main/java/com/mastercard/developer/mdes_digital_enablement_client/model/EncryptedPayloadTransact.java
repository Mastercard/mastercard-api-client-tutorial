...
public class EncryptedPayloadTransact {
  ...
  public EncryptedPayloadTransact() {
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to EncryptedPayloadTransact
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EncryptedPayloadTransact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EncryptedPayloadTransact is not found in the empty JSON string", EncryptedPayloadTransact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EncryptedPayloadTransact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EncryptedPayloadTransact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("encryptedData") != null && !jsonObj.get("encryptedData").isJsonNull()) {
        TransactEncryptedData.validateJsonElement(jsonObj.get("encryptedData"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EncryptedPayloadTransact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EncryptedPayloadTransact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EncryptedPayloadTransact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EncryptedPayloadTransact.class));

       return (TypeAdapter<T>) new TypeAdapter<EncryptedPayloadTransact>() {
           @Override
           public void write(JsonWriter out, EncryptedPayloadTransact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EncryptedPayloadTransact read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of EncryptedPayloadTransact given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EncryptedPayloadTransact
  * @throws IOException if the JSON string is invalid with respect to EncryptedPayloadTransact
  */
  public static EncryptedPayloadTransact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncryptedPayloadTransact.class);
  }

 /**
  * Convert an instance of EncryptedPayloadTransact to an JSON string
  *
  * @return JSON string
  */
