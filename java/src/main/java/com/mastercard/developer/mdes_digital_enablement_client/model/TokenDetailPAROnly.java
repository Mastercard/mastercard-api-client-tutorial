...
public class TokenDetailPAROnly {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TokenDetailPAROnly
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenDetailPAROnly.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TokenDetailPAROnly is not found in the empty JSON string", TokenDetailPAROnly.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TokenDetailPAROnly.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TokenDetailPAROnly` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("encryptedData") != null && !jsonObj.get("encryptedData").isJsonNull()) {
        TokenDetailDataPAROnly.validateJsonElement(jsonObj.get("encryptedData"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TokenDetailPAROnly.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TokenDetailPAROnly' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TokenDetailPAROnly> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TokenDetailPAROnly.class));

       return (TypeAdapter<T>) new TypeAdapter<TokenDetailPAROnly>() {
           @Override
           public void write(JsonWriter out, TokenDetailPAROnly value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TokenDetailPAROnly read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TokenDetailPAROnly given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TokenDetailPAROnly
  * @throws IOException if the JSON string is invalid with respect to TokenDetailPAROnly
  */
  public static TokenDetailPAROnly fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TokenDetailPAROnly.class);
  }

 /**
  * Convert an instance of TokenDetailPAROnly to an JSON string
  *
  * @return JSON string
  */
