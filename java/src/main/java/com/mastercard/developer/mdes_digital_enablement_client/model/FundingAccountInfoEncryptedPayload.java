...
public class FundingAccountInfoEncryptedPayload {
  ...
  public FundingAccountInfoEncryptedPayload() {
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FundingAccountInfoEncryptedPayload fundingAccountInfoEncryptedPayload = (FundingAccountInfoEncryptedPayload) o;
    return Objects.equals(this.publicKeyFingerprint, fundingAccountInfoEncryptedPayload.publicKeyFingerprint) &&
        Objects.equals(this.encryptedKey, fundingAccountInfoEncryptedPayload.encryptedKey) &&
        Objects.equals(this.oaepHashingAlgorithm, fundingAccountInfoEncryptedPayload.oaepHashingAlgorithm) &&
        Objects.equals(this.iv, fundingAccountInfoEncryptedPayload.iv) &&
        Objects.equals(this.encryptedData, fundingAccountInfoEncryptedPayload.encryptedData);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to FundingAccountInfoEncryptedPayload
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FundingAccountInfoEncryptedPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FundingAccountInfoEncryptedPayload is not found in the empty JSON string", FundingAccountInfoEncryptedPayload.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FundingAccountInfoEncryptedPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FundingAccountInfoEncryptedPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("encryptedData") != null && !jsonObj.get("encryptedData").isJsonNull()) {
        FundingAccountData.validateJsonElement(jsonObj.get("encryptedData"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FundingAccountInfoEncryptedPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FundingAccountInfoEncryptedPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FundingAccountInfoEncryptedPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FundingAccountInfoEncryptedPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<FundingAccountInfoEncryptedPayload>() {
           @Override
           public void write(JsonWriter out, FundingAccountInfoEncryptedPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FundingAccountInfoEncryptedPayload read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FundingAccountInfoEncryptedPayload given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FundingAccountInfoEncryptedPayload
  * @throws IOException if the JSON string is invalid with respect to FundingAccountInfoEncryptedPayload
  */
  public static FundingAccountInfoEncryptedPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FundingAccountInfoEncryptedPayload.class);
  }

 /**
  * Convert an instance of FundingAccountInfoEncryptedPayload to an JSON string
  *
  * @return JSON string
  */
