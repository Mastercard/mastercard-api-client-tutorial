...
public class FundingAccountInfoEncryptedPayload {
  ...
  **/
  ...
  @ApiModelProperty(example = "4c4ead5927f0df8117f178eea9308daa58e27c2b", value = "The fingerprint of the public key used to encrypt the ephemeral AES key. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "A1B2C3D4E5F6112233445566", value = "One-time use AES key encrypted by the MasterCard public key (as identified by publicKeyFingerprint) using the OAEP or PKCS#1 v1.5 scheme (depending on the value of oaepHashingAlgorithm. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "NA", value = "The initialization vector used when encrypting data using the one-time use AES key. Must be exactly 16 bytes (32 character hex string) to match the block size. If not present, an IV of zero is assumed. ")
