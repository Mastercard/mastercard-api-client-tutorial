...
public class TokenizeApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Contains the details of the token response message when a push account receipt is supplied in the tokenize request.  </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> unexpected error  </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Contains the details of the response message when a push account receipt is not supplied in the tokenize request.  </td><td>  -  </td></tr>
     </table>
     */
