...
public class SuspendRequestSchema {
  ...
  * @throws IOException if the JSON Element is invalid with respect to SuspendRequestSchema
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SuspendRequestSchema.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SuspendRequestSchema is not found in the empty JSON string", SuspendRequestSchema.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SuspendRequestSchema.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SuspendRequestSchema` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SuspendRequestSchema.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SuspendRequestSchema.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SuspendRequestSchema' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SuspendRequestSchema> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SuspendRequestSchema.class));

       return (TypeAdapter<T>) new TypeAdapter<SuspendRequestSchema>() {
           @Override
           public void write(JsonWriter out, SuspendRequestSchema value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SuspendRequestSchema read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of SuspendRequestSchema given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SuspendRequestSchema
  * @throws IOException if the JSON string is invalid with respect to SuspendRequestSchema
  */
  public static SuspendRequestSchema fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SuspendRequestSchema.class);
  }

 /**
  * Convert an instance of SuspendRequestSchema to an JSON string
  *
  * @return JSON string
  */
