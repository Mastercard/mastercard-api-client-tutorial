...
import org.openapitools.client.model.AccountHolderData;
import org.openapitools.client.model.CardAccountDataInbound;
...
public class FundingAccountData {
  ...
  **/
  ...
  public FundingAccountData source(String source) {
   ...
   /**
   * (__Required as minimum for Tokenization__)  The source of the account. Must be one of   * ACCOUNT_ON_FILE  * ACCOUNT_ADDED_MANUALLY  * ACCOUNT_ADDED_VIA_APPLICATION  &lt;br&gt; __Max Length:32__ 
   * @return source
  **/
  @ApiModelProperty(example = "ACCOUNT_ON_FILE", value = "(__Required as minimum for Tokenization__)  The source of the account. Must be one of   * ACCOUNT_ON_FILE  * ACCOUNT_ADDED_MANUALLY  * ACCOUNT_ADDED_VIA_APPLICATION  <br> __Max Length:32__ ")
