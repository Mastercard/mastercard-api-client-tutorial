...
import com.mastercard.developer.mdes_digital_enablement_client.model.SearchTokensRequestSchema;
import com.mastercard.developer.mdes_digital_enablement_client.model.SearchTokensResponseSchema;
...
/**
 * API tests for SearchTokensApi
 */
@Ignore
public class SearchTokensApiTest {

    private final SearchTokensApi api = new SearchTokensApi();
    ...
    public void searchTokensTest() throws ApiException {
        SearchTokensRequestSchema searchTokensRequestSchema = null;
        SearchTokensResponseSchema response = api.searchTokens(searchTokensRequestSchema);
