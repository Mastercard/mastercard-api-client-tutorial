...
/**
 * API tests for TransactApi
 */
@Ignore
public class TransactApiTest {

    private final TransactApi api = new TransactApi();
     ...
     */
    @Test
    public void createTransactTest() throws ApiException {
        TransactRequestSchema transactRequestSchema = null;
        TransactResponseSchema response = api.createTransact(transactRequestSchema);
