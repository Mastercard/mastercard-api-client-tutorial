...
class TokenizeRequestSchema(object):
    ...
    def __init__(self, response_host=None, request_id=None, token_type=None, token_requestor_id=None, task_id=None, funding_account_info=None, consumer_language=None, tokenization_authentication_value=None, decisioning_data=None):  # noqa: E501
    ...
    def funding_account_info(self, funding_account_info):
        ...
        """
        if funding_account_info is None:
