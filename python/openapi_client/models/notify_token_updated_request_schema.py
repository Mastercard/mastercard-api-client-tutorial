...
class NotifyTokenUpdatedRequestSchema(object):
    ...
    def __init__(self, response_host=None, request_id=None, encrypted_payload=None, local_vars_configuration=None):  # noqa: E501
    ...
    def response_host(self, response_host):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and response_host is None:  # noqa: E501
    ...
    def encrypted_payload(self, encrypted_payload):
        ...
        """
        if self.local_vars_configuration.client_side_validation and encrypted_payload is None:  # noqa: E501
