...
class TokenDetailGetTokenOnly(object):
    ...
    def __init__(self, token_unique_reference=None, public_key_fingerprint=None, encrypted_key=None, oaep_hashing_algorithm=None, encrypted_data=None, local_vars_configuration=None):  # noqa: E501
        """TokenDetailGetTokenOnly - a model defined in OpenAPI"""  # noqa: E501
    ...
    def token_unique_reference(self):
        """Gets the token_unique_reference of this TokenDetailGetTokenOnly.  # noqa: E501

        Globally unique identifier for the Token, as assigned by MDES.<br>     __Max Length:64__   # noqa: E501

        :return: The token_unique_reference of this TokenDetailGetTokenOnly.  # noqa: E501
        :rtype: str
        """
    ...
    def token_unique_reference(self, token_unique_reference):
        """Sets the token_unique_reference of this TokenDetailGetTokenOnly.

        Globally unique identifier for the Token, as assigned by MDES.<br>     __Max Length:64__   # noqa: E501

        :param token_unique_reference: The token_unique_reference of this TokenDetailGetTokenOnly.  # noqa: E501
        :type: str
        """
    ...
    def public_key_fingerprint(self):
        """Gets the public_key_fingerprint of this TokenDetailGetTokenOnly.  # noqa: E501
        ...
        :return: The public_key_fingerprint of this TokenDetailGetTokenOnly.  # noqa: E501
        :rtype: str
        """
    ...
    def public_key_fingerprint(self, public_key_fingerprint):
        """Sets the public_key_fingerprint of this TokenDetailGetTokenOnly.

        The certificate fingerprint identifying the public key used to encrypt the ephemeral AES key.<br>     __Max Length:64__ Hex-encoded data (case-insensitive).   # noqa: E501

        :param public_key_fingerprint: The public_key_fingerprint of this TokenDetailGetTokenOnly.  # noqa: E501
        :type: str
        """
    ...
    def encrypted_key(self):
        """Gets the encrypted_key of this TokenDetailGetTokenOnly.  # noqa: E501
        ...
        :return: The encrypted_key of this TokenDetailGetTokenOnly.  # noqa: E501
        :rtype: str
        """
    ...
    def encrypted_key(self, encrypted_key):
        """Sets the encrypted_key of this TokenDetailGetTokenOnly.

        One-time use AES key encrypted by the MasterCard public key (as identified by 'publicKeyFingerprint') using the OAEP or RSA Encryption Standard PKCS #1 v1.5 scheme (depending on the value of 'oaepHashingAlgorithm'. Requirement is for a 128-bit key (with 256-bit key supported as an option).<br>     __Max Length:512__   # noqa: E501

        :param encrypted_key: The encrypted_key of this TokenDetailGetTokenOnly.  # noqa: E501
        :type: str
        """
    ...
    def oaep_hashing_algorithm(self):
        """Gets the oaep_hashing_algorithm of this TokenDetailGetTokenOnly.  # noqa: E501
        ...
        :return: The oaep_hashing_algorithm of this TokenDetailGetTokenOnly.  # noqa: E501
        :rtype: str
        """
    ...
    def oaep_hashing_algorithm(self, oaep_hashing_algorithm):
        """Sets the oaep_hashing_algorithm of this TokenDetailGetTokenOnly.

        Hashing algorithm used with the OAEP scheme. If omitted, then the RSA Encryption Standard PKCS #1 v1.5 will be used. Must be either 'SHA256' (Use the SHA-256 algorithm) or 'SHA512' (Use the SHA-512 algorithm).<br>     __Max Length:6__   # noqa: E501

        :param oaep_hashing_algorithm: The oaep_hashing_algorithm of this TokenDetailGetTokenOnly.  # noqa: E501
        :type: str
        """
    ...
    def encrypted_data(self):
        """Gets the encrypted_data of this TokenDetailGetTokenOnly.  # noqa: E501


        :return: The encrypted_data of this TokenDetailGetTokenOnly.  # noqa: E501
        :rtype: TokenDetailDataGetTokenOnly
        """
        return self._encrypted_data

    @encrypted_data.setter
    def encrypted_data(self, encrypted_data):
        """Sets the encrypted_data of this TokenDetailGetTokenOnly.


        :param encrypted_data: The encrypted_data of this TokenDetailGetTokenOnly.  # noqa: E501
        :type: TokenDetailDataGetTokenOnly
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenDetailGetTokenOnly):
            return False
