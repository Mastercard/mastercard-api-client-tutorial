...
class TokenDetailDataTCCOnly(object):
    ...
    """
    openapi_types = {
        'account_holder_data': 'AccountHolderDataOutbound',
        'payment_account_reference': 'str',
        'card_account_data': 'CardAccountDataOutbound'
    }
    ...
    def __init__(self, account_holder_data=None, payment_account_reference=None, card_account_data=None):  # noqa: E501
        """TokenDetailDataTCCOnly - a model defined in OpenAPI"""  # noqa: E501
    ...
    def account_holder_data(self):
        """Gets the account_holder_data of this TokenDetailDataTCCOnly.  # noqa: E501


        :return: The account_holder_data of this TokenDetailDataTCCOnly.  # noqa: E501
        :rtype: AccountHolderDataOutbound
        """
        return self._account_holder_data

    @account_holder_data.setter
    def account_holder_data(self, account_holder_data):
        """Sets the account_holder_data of this TokenDetailDataTCCOnly.


        :param account_holder_data: The account_holder_data of this TokenDetailDataTCCOnly.  # noqa: E501
        :type: AccountHolderDataOutbound
        """
    ...
    def payment_account_reference(self):
        """Gets the payment_account_reference of this TokenDetailDataTCCOnly.  # noqa: E501
        ...
        :return: The payment_account_reference of this TokenDetailDataTCCOnly.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_account_reference(self, payment_account_reference):
        """Sets the payment_account_reference of this TokenDetailDataTCCOnly.

        The unique account reference assigned to the PAN. Conditionally returned if the Token Requestor has opted to receive PAR and providing PAR is assigned by Mastercard or the Issuer provides PAR in the authorization message response. <br>    __Max Length: 29__   # noqa: E501

        :param payment_account_reference: The payment_account_reference of this TokenDetailDataTCCOnly.  # noqa: E501
        :type: str
        """
    ...
    def card_account_data(self):
        """Gets the card_account_data of this TokenDetailDataTCCOnly.  # noqa: E501


        :return: The card_account_data of this TokenDetailDataTCCOnly.  # noqa: E501
        :rtype: CardAccountDataOutbound
        """
        return self._card_account_data

    @card_account_data.setter
    def card_account_data(self, card_account_data):
        """Sets the card_account_data of this TokenDetailDataTCCOnly.


        :param card_account_data: The card_account_data of this TokenDetailDataTCCOnly.  # noqa: E501
        :type: CardAccountDataOutbound
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenDetailDataTCCOnly):
            return False
