...
class TokenForLCM(object):
    ...
    def __init__(self, token_unique_reference=None, status=None, suspended_by=None, status_timestamp=None, error_code=None, error_description=None, errors=None):  # noqa: E501
    ...
    def token_unique_reference(self):
        """Gets the token_unique_reference of this TokenForLCM.  # noqa: E501
        ...
        :return: The token_unique_reference of this TokenForLCM.  # noqa: E501
        :rtype: str
        """
    ...
    def token_unique_reference(self, token_unique_reference):
        """Sets the token_unique_reference of this TokenForLCM.

        The unique reference allocated to the Token which is always present even if an error occurs. <br>      __Max Length:64__   # noqa: E501

        :param token_unique_reference: The token_unique_reference of this TokenForLCM.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this TokenForLCM.  # noqa: E501
        ...
        :return: The status of this TokenForLCM.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this TokenForLCM.

        The current status of Token. Must be either:    * 'INACTIVE' (Token has not yet been activated)  * 'ACTIVE' (Token is active and ready to transact)  * 'SUSPENDED' (Token is suspended and unable to transact)  * 'DEACTIVATED' (Token has been permanently deactivated).<br>      __Max Length:32__   # noqa: E501

        :param status: The status of this TokenForLCM.  # noqa: E501
        :type: str
        """
    ...
    def suspended_by(self):
        """Gets the suspended_by of this TokenForLCM.  # noqa: E501
        ...
        :return: The suspended_by of this TokenForLCM.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def suspended_by(self, suspended_by):
        """Sets the suspended_by of this TokenForLCM.

        (CONDITIONAL only supplied if status is SUSPENDED) Who or what caused the Token to be suspended One or more values of:     * ISSUER - Suspended by the Issuer.    * TOKEN_REQUESTOR - Suspended by the Token Requestor     * MOBILE_PIN_LOCKED - Suspended due to the Mobile PIN being locked    * CARDHOLDER - Suspended by the Cardholder <br>          __Max Length__: N/A       # noqa: E501

        :param suspended_by: The suspended_by of this TokenForLCM.  # noqa: E501
        :type: list[str]
        """
    ...
    def status_timestamp(self):
        """Gets the status_timestamp of this TokenForLCM.  # noqa: E501
        ...
        :return: The status_timestamp of this TokenForLCM.  # noqa: E501
        :rtype: str
        """
    ...
    def status_timestamp(self, status_timestamp):
        """Sets the status_timestamp of this TokenForLCM.

        The date and time the token status was last updated. Expressed in ISO 8601 extended format as one of the following:     * YYYY-MM-DDThh:mm:ss[.sss]Z    * YYYY-MM-DDThh:mm:ss[.sss]±hh:mm    * Where [.sss] is optional and can be 1 to 3 digits. <br>  __Max Length:29__     # noqa: E501

        :param status_timestamp: The status_timestamp of this TokenForLCM.  # noqa: E501
        :type: str
        """
    ...
    @property
    def error_code(self):
        """Gets the error_code of this TokenForLCM.  # noqa: E501
        ...
        :return: The error_code of this TokenForLCM.  # noqa: E501
        :rtype: str
        """
    ...
    def error_code(self, error_code):
        """Sets the error_code of this TokenForLCM.

        __CONDITIONAL__<br> Returned in the event of an error and contains the reason the operation failed. Only use if errors object is not present.<br> __Max Length: 32__   # noqa: E501

        :param error_code: The error_code of this TokenForLCM.  # noqa: E501
        :type: str
        """
    ...
    def error_description(self):
        """Gets the error_description of this TokenForLCM.  # noqa: E501
        ...
        :return: The error_description of this TokenForLCM.  # noqa: E501
        :rtype: str
        """
    ...
    def error_description(self, error_description):
        """Sets the error_description of this TokenForLCM.

        __CONDITIONAL__<br> Returned in the event of an error and contains a description of why the operation failed. Only use if errors object is not present.<br> __Max Length: 32__     # noqa: E501

        :param error_description: The error_description of this TokenForLCM.  # noqa: E501
        :type: str
        """
    ...
    @property
    def errors(self):
        """Gets the errors of this TokenForLCM.  # noqa: E501


        :return: The errors of this TokenForLCM.  # noqa: E501
        :rtype: list[Error]
        """
        return self._errors
    ...
    def errors(self, errors):
        """Sets the errors of this TokenForLCM.


        :param errors: The errors of this TokenForLCM.  # noqa: E501
        :type: list[Error]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenForLCM):
            return False
