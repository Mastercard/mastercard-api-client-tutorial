...
class TransactError(object):
    ...
    def __init__(self, source=None, error_code=None, description=None, reason_code=None, error_description=None, local_vars_configuration=None):  # noqa: E501
        """TransactError - a model defined in OpenAPI"""  # noqa: E501
