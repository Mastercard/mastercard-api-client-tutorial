...
class AccountHolderDataOutbound(object):
    ...
    def __init__(self, account_holder_name=None, account_holder_address=None, account_holder_email_address=None, account_holder_mobile_phone_number=None):  # noqa: E501
