...
class Token(object):
    ...
    def __init__(self, token_unique_reference=None, status=None, suspended_by=None, status_timestamp=None, product_config=None, token_info=None, local_vars_configuration=None):  # noqa: E501
