...
class SearchTokensApi(object):
    ...
    def search_tokens_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(SearchTokensResponseSchema, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        body_params = None
        if 'search_tokens_request_schema' in local_var_params:
            body_params = local_var_params['search_tokens_request_schema']
        # HTTP header `Accept`
