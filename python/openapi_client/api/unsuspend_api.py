    ...
    def __init__(self, api_client=None):
        ...
        def __create_unsuspend(
            ...
            **kwargs
            ...
            Keyword Args:
                un_suspend_request_schema (UnSuspendRequestSchema): Contains the details of the request message. . [optional]
        ...
        self.create_unsuspend = _Endpoint(
            settings={
                'response_type': (UnSuspendResponseSchema,),
                'auth': [],
                'endpoint_path': '/digitization/static/1/0/unsuspend',
                'operation_id': 'create_unsuspend',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'un_suspend_request_schema': 'body',
                },
