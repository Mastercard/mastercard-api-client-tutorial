...
class TransactApi:
    ...
    def create_transact(
        self,
        transact_request_schema: Annotated[Optional[TransactRequestSchema], Field(description="Contains the details of the request message. ")] = None,
        ...
        :param transact_request_schema: Contains the details of the request message. 
        :type transact_request_schema: TransactRequestSchema
        ...
        _param = self._create_transact_serialize(
            transact_request_schema=transact_request_schema,
    ...
    @validate_call
    def create_transact_with_http_info(
        self,
        transact_request_schema: Annotated[Optional[TransactRequestSchema], Field(description="Contains the details of the request message. ")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransactResponseSchema]:
        """Used by the Token Requestor to create a Digital Secure Remote Payment (\"DSRP\") transaction cryptogram using the credentials stored within MDES in order to perform a DSRP transaction.
    ...
    @validate_call
    def create_transact_without_preload_content(
        self,
        transact_request_schema: Annotated[Optional[TransactRequestSchema], Field(description="Contains the details of the request message. ")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_transact_serialize(
        self,
        ...
        if transact_request_schema is not None:
            _body_params = transact_request_schema
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/remotetransaction/static/1/0/transact',
