    ...
    def __init__(self, api_client=None):
        ...
        def __delete_digitization(
            ...
            **kwargs
            ...
            >>> thread = api.delete_digitization(async_req=True)
            >>> result = thread.get()


            Keyword Args:
                delete_request_schema (DeleteRequestSchema): Contains the details of the request message. . [optional]
        ...
        self.delete_digitization = _Endpoint(
            settings={
                'response_type': (DeleteResponseSchema,),
                'auth': [],
                'endpoint_path': '/digitization/static/1/0/delete',
                'operation_id': 'delete_digitization',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__delete_digitization
        )
