...
class GetTokenApi:
    ...
    def get_token(
        self,
        get_token_request_schema: Annotated[Optional[GetTokenRequestSchema], Field(description="Contains the details of the request message. ")] = None,
        ...
        :param get_token_request_schema: Contains the details of the request message. 
        :type get_token_request_schema: GetTokenRequestSchema
        ...
        _param = self._get_token_serialize(
            get_token_request_schema=get_token_request_schema,
    ...
    def get_token_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetTokenResponseSchema]:
        """Used to get the status and details of a single given Token.
    ...
    def _get_token_serialize(
        ...
        if get_token_request_schema is not None:
            _body_params = get_token_request_schema
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/digitization/static/1/0/getToken',
