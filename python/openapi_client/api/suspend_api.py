...
class SuspendApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_suspend(
            self,
            **kwargs
        ):
            """Used to temporarily suspend one or more Tokens.  # noqa: E501
            ...
            Keyword Args:
                suspend_request_schema (SuspendRequestSchema): Contains the details of the request message. . [optional]
        ...
        self.create_suspend = _Endpoint(
            settings={
                'response_type': (SuspendResponseSchema,),
                'auth': [],
                'endpoint_path': '/digitization/static/1/0/suspend',
                'operation_id': 'create_suspend',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
