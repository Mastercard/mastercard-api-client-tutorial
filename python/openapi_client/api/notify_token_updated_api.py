...
class NotifyTokenUpdatedApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __notify_token_update__for_token_state_change(
            self,
            **kwargs
        ):
            ...
            Keyword Args:
                notify_token_updated_request_schema (NotifyTokenUpdatedRequestSchema): Contains the details of the request message. . [optional]
        ...
        self.notify_token_update__for_token_state_change = _Endpoint(
            settings={
                'response_type': (NotifyTokenUpdatedResponseSchema,),
                'auth': [],
                'endpoint_path': '/digitization/static/1/0/notifyTokenUpdated',
                'operation_id': 'notify_token_update__for_token_state_change',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'notify_token_updated_request_schema': 'body',
                },
            ...
            callable=__notify_token_update__for_token_state_change
        )
