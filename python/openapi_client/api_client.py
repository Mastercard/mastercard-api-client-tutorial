...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DeleteApi()
        api_instance.delete_digitization  # this is an instance of the class Endpoint
        api_instance.delete_digitization()  # this invokes api_instance.delete_digitization.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_digitization.callable or self.callable in this class
