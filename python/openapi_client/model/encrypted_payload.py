...
def lazy_import():
    ...
    globals()['NotifyTokenEncryptedPayload'] = NotifyTokenEncryptedPayload


class EncryptedPayload(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'encrypted_data': (NotifyTokenEncryptedPayload,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, public_key_fingerprint, encrypted_key, encrypted_data, *args, **kwargs):  # noqa: E501
        """EncryptedPayload - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            iv (str): The initialization vector used when encrypting data using the one-time use AES key. Must be exactly 16 bytes (32 character hex string) to match the block size. If not present, an IV of zero is assumed. Length - 32. . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, public_key_fingerprint, encrypted_key, encrypted_data, *args, **kwargs):  # noqa: E501
        """EncryptedPayload - a model defined in OpenAPI
