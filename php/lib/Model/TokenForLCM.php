 ...
 */
class TokenForLCM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setStatusTimestamp($status_timestamp)
    {
        if (!is_null($status_timestamp) && (mb_strlen($status_timestamp) > 29)) {
            throw new \InvalidArgumentException('invalid length for $status_timestamp when calling TokenForLCM., must be smaller than or equal to 29.');
        }
