...
class AccountHolderData implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $account_holder_name __(OPTIONAL)__ The name of the cardholder in the format LASTNAME/FIRSTNAME or FIRSTNAME LASTNAME<br> __Max Length:27__
     *
     * @return $this
     */
     ...
     *
     * @param string|null $consumer_identifier __(OPTIONAL)__ Customer Identifier that may be required in some regions.<br> __Max Length:88__
     *
     * @return $this
     */
