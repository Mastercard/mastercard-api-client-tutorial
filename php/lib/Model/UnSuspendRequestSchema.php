 ...
 */
class UnSuspendRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPaymentAppInstanceId($payment_app_instance_id)
    {
        if (!is_null($payment_app_instance_id) && (mb_strlen($payment_app_instance_id) > 48)) {
            throw new \InvalidArgumentException('invalid length for $payment_app_instance_id when calling UnSuspendRequestSchema., must be smaller than or equal to 48.');
        }
     ...
     * Sets caused_by
     *
     * @param string $caused_by Who or what caused the Token to be unsuspended. Must be either the 'CARDHOLDER' (operation requested by the Cardholder) or 'TOKEN_REQUESTOR' (operation requested by the token requestor).
     *
     * @return self
     */
    public function setCausedBy($caused_by)
    {
        if ((mb_strlen($caused_by) > 64)) {
            throw new \InvalidArgumentException('invalid length for $caused_by when calling UnSuspendRequestSchema., must be smaller than or equal to 64.');
        }
    ...
    public function setReason($reason)
    {
        if (!is_null($reason) && (mb_strlen($reason) > 256)) {
            throw new \InvalidArgumentException('invalid length for $reason when calling UnSuspendRequestSchema., must be smaller than or equal to 256.');
        }
     ...
     * Sets reason_code
     *
     * @param string $reason_code The reason for the action to be unsuspended. Must be one of 'SUSPECTED_FRAUD' (suspected fraudulent token transactions), 'OTHER' (Other - default used if value not provided).
     *
     * @return self
     */
    public function setReasonCode($reason_code)
    {
        if ((mb_strlen($reason_code) > 64)) {
            throw new \InvalidArgumentException('invalid length for $reason_code when calling UnSuspendRequestSchema., must be smaller than or equal to 64.');
        }
