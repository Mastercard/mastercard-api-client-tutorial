...
class TokenInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTokenPanSuffix($token_pan_suffix)
    {
        if ((mb_strlen($token_pan_suffix) > 8)) {
            throw new \InvalidArgumentException('invalid length for $token_pan_suffix when calling TokenInfo., must be smaller than or equal to 8.');
        }
    ...
    public function setAccountPanSuffix($account_pan_suffix)
    {
        if ((mb_strlen($account_pan_suffix) > 8)) {
            throw new \InvalidArgumentException('invalid length for $account_pan_suffix when calling TokenInfo., must be smaller than or equal to 8.');
        }
    ...
    public function setTokenExpiry($token_expiry)
    {
        if ((mb_strlen($token_expiry) > 4)) {
            throw new \InvalidArgumentException('invalid length for $token_expiry when calling TokenInfo., must be smaller than or equal to 4.');
        }
    ...
    public function setAccountPanExpiry($account_pan_expiry)
    {
        if (!is_null($account_pan_expiry) && (mb_strlen($account_pan_expiry) > 4)) {
            throw new \InvalidArgumentException('invalid length for $account_pan_expiry when calling TokenInfo., must be smaller than or equal to 4.');
        }
    ...
    public function setDsrpCapable($dsrp_capable)
    {
        if ((mb_strlen($dsrp_capable) > 5)) {
            throw new \InvalidArgumentException('invalid length for $dsrp_capable when calling TokenInfo., must be smaller than or equal to 5.');
        }
    ...
    public function setProductCategory($product_category)
    {
        if (!is_null($product_category) && (mb_strlen($product_category) > 32)) {
            throw new \InvalidArgumentException('invalid length for $product_category when calling TokenInfo., must be smaller than or equal to 32.');
        }
