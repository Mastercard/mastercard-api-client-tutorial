 ...
 */
class GetTokenRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['include_token_detail'] = $data['include_token_detail'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['include_token_detail']) && (mb_strlen($this->container['include_token_detail']) > 5)) {
            $invalidProperties[] = "invalid value for 'include_token_detail', the character length must be smaller than or equal to 5.";
        }
    ...
    public function setPaymentAppInstanceId($payment_app_instance_id)
    {
        if (!is_null($payment_app_instance_id) && (mb_strlen($payment_app_instance_id) > 48)) {
            throw new \InvalidArgumentException('invalid length for $payment_app_instance_id when calling GetTokenRequestSchema., must be smaller than or equal to 48.');
        }
     ...
     *
     * @param string $token_unique_reference The specific Token to be queried.
     *
     * @return self
     */
    public function setTokenUniqueReference($token_unique_reference)
    {
        if ((mb_strlen($token_unique_reference) > 64)) {
            throw new \InvalidArgumentException('invalid length for $token_unique_reference when calling GetTokenRequestSchema., must be smaller than or equal to 64.');
        }
     ...
     *
     * @param string|null $include_token_detail Flag to indicate if the encrypted token should be returned.
     *
     * @return self
     */
    public function setIncludeTokenDetail($include_token_detail)
    {
        if (!is_null($include_token_detail) && (mb_strlen($include_token_detail) > 5)) {
            throw new \InvalidArgumentException('invalid length for $include_token_detail when calling GetTokenRequestSchema., must be smaller than or equal to 5.');
        }
