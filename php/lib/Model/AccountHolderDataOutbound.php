 ...
 */
class AccountHolderDataOutbound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $account_holder_name **(OPTIONAL)** The name of the cardholder
     *
     * @return self
     */
    public function setAccountHolderName($account_holder_name)
    {
        if (!is_null($account_holder_name) && (mb_strlen($account_holder_name) > 27)) {
            throw new \InvalidArgumentException('invalid length for $account_holder_name when calling AccountHolderDataOutbound., must be smaller than or equal to 27.');
        }
    ...
    public function setAccountHolderEmailAddress($account_holder_email_address)
    {
        if (!is_null($account_holder_email_address) && (mb_strlen($account_holder_email_address) > 320)) {
            throw new \InvalidArgumentException('invalid length for $account_holder_email_address when calling AccountHolderDataOutbound., must be smaller than or equal to 320.');
        }
