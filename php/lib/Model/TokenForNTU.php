 ...
 */
class TokenForNTU implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'token_for_NTU';
     ...
     *
     * @param string|null $token_unique_reference The unique reference allocated to the Token which is always present even if an error occurs. <br> maxLength: 64
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The current status of Token. Must be either: * 'INACTIVE' (Token has not yet been activated) * 'ACTIVE' (Token is active and ready to transact) * 'SUSPENDED' (Token is suspended and unable to transact) * 'DEACTIVATED' (Token has been permanently deactivated).<br> maxLength: 32
     *
     * @return self
     */
     ...
     *
     * @param string|null $status_timestamp The date and time the token status was last updated. Expressed in ISO 8601 extended format as one of the following:   * YYYY-MM-DDThh:mm:ss[.sss]Z   * YYYY-MM-DDThh:mm:ss[.sss]±hh:mm   * Where [.sss] is optional and can be 1 to 3 digits. <br>
     *
     * @return self
     */
    public function setStatusTimestamp($status_timestamp)
    {
        if (!is_null($status_timestamp) && (mb_strlen($status_timestamp) > 29)) {
            throw new \InvalidArgumentException('invalid length for $status_timestamp when calling TokenForNTU., must be smaller than or equal to 29.');
        }
