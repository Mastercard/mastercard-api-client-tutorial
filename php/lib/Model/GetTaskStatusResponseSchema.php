 ...
 */
class GetTaskStatusResponseSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets status
     *
     * @param string|null $status The status of the specified task. Must be either 'PENDING' (The Task has been recieved and is pending processing), 'IN_PROGRESS' (The task is currently in progress), 'COMPLETED' (The task was completed successfully) or 'FAILED' The task was processed but failed to complete successfully.
     *
     * @return self
     */
    public function setStatus($status)
    {
        if (!is_null($status) && (mb_strlen($status) > 64)) {
            throw new \InvalidArgumentException('invalid length for $status when calling GetTaskStatusResponseSchema., must be smaller than or equal to 64.');
        }
