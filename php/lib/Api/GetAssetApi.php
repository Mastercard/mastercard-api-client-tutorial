...
class GetAssetApi
{
     ...
     * @return \OpenAPI\Client\Model\AssetResponseSchema|\OpenAPI\Client\Model\ErrorsResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AssetResponseSchema|\OpenAPI\Client\Model\ErrorsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAssetWithHttpInfo($asset_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\AssetResponseSchema' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\AssetResponseSchema', []),
            ...
            $returnType = '\OpenAPI\Client\Model\AssetResponseSchema';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\AssetResponseSchema',
