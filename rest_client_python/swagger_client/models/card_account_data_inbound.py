...
class CardAccountDataInbound(object):
    ...
    def __init__(self, account_number=None, expiry_month=None, expiry_year=None, security_code=None):  # noqa: E501
        """CardAccountDataInbound - a model defined in Swagger"""  # noqa: E501
    ...
    def account_number(self):
        ...
        The account number of the credit or debit card.   __(CONDITIONAL)__ <br>required in a Tokenize, or Get Digital Asset request, unless a valid panUniqueReference or tokenUniqueReference was given in FundingAccountInfo.  </br></br>  __Min Length:9 (See note)__</br> __Max Length:19__ </br> </br> __NOTE__: Only 6 digits can be supplied in SearchTokens if the TokenUniqueReference is provided in fundingAccountInfo.   # noqa: E501
    ...
    def expiry_month(self):
        """Gets the expiry_month of this CardAccountDataInbound.  # noqa: E501
          ...
          The expiry month for the account. Two numeric digits must be supplied.  <br>Only supplied in tokenization requests if panUniqueReference or tokenUniqueReferenceForPanInfo is not present.  __Format: MM__<br> __Exact Length:2__   # noqa: E501
    ...
    def expiry_year(self):
        ...
        __(Required as minimum for Tokenization)__  The expiry year for the account. <br>Only supplied in tokenization requests if panUniqueReference or tokenUniqueReferenceForPanInfo is not present.   __Format: YY__ <br> __Exact Length:2__   # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CardAccountDataInbound, dict):
