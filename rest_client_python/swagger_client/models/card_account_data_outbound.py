...
class CardAccountDataOutbound(object):
    ...
    def __init__(self, account_number=None, expiry_month=None, expiry_year=None):  # noqa: E501
        """CardAccountDataOutbound - a model defined in Swagger"""  # noqa: E501
    ...
    def expiry_month(self):
        """Gets the expiry_month of this CardAccountDataOutbound.  # noqa: E501
          ...
          The expiry month for the account. Two numeric digits must be supplied.  <br>Only supplied in tokenization requests if panUniqueReference or tokenUniqueReferenceForPanInfo is not present. <br> Only returned in tokenization response if a pushAccountReceipt was supplied in the tokenization request and if there is account holder data associated with the push account receipt in case that the issuer decision is APPROVED   __Format: MM__<br> __Exact Length:2__   # noqa: E501
    ...
    def expiry_year(self):
        ...
        __(Required as minimum for Tokenization)__  The expiry year for the account. <br>Only supplied in tokenization requests if panUniqueReference or tokenUniqueReferenceForPanInfo is not present. <br> Only returned in tokenization response if a pushAccountReceipt was supplied in the tokenization request and if there is account holder data associated with the push account receipt in case that the issuer decision is APPROVED __Format: YY__ <br> __Exact Length:2__   # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CardAccountDataOutbound, dict):
