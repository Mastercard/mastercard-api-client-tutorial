...
namespace Mastercard.Developer.DigitalEnablement.Client.Api
{
    ...
    public interface ISuspendApi : IApiAccessor
    {
        ...
        ApiResponse<SuspendResponseSchema> CreateSuspendWithHttpInfo (SuspendRequestSchema suspendRequestSchema = null);
        ...
        System.Threading.Tasks.Task<SuspendResponseSchema> CreateSuspendAsync (SuspendRequestSchema suspendRequestSchema = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<SuspendResponseSchema>> CreateSuspendAsyncWithHttpInfo (SuspendRequestSchema suspendRequestSchema = null);
    ...
    public partial class SuspendApi : ISuspendApi
    {
        ...
        /// <summary>
        /// Used to temporarily suspend one or more Tokens (for example, suspending all Tokens on a device in response to the device being lost).  The API is limited to 10 Tokens per request. This API is used to temporarily suspend one or more Tokens (for example, suspending all Tokens on a device in response to the device being lost).  The API is limited to 10 Tokens per request. MDES will coordinate the suspension of the Tokens and notify any relevant parties that the Tokens have been suspended. A suspended Token can be unsuspended using the Unsuspend resource. 
        /// </summary>
        /// <exception cref="Mastercard.Developer.DigitalEnablement.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="suspendRequestSchema">Contains the details of the request message.  (optional)</param>
        /// <returns>SuspendResponseSchema</returns>
        public SuspendResponseSchema CreateSuspend (SuspendRequestSchema suspendRequestSchema = null)
        {
        ...
        /// <param name="suspendRequestSchema">Contains the details of the request message.  (optional)</param>
        /// <returns>ApiResponse of SuspendResponseSchema</returns>
        public ApiResponse< SuspendResponseSchema > CreateSuspendWithHttpInfo (SuspendRequestSchema suspendRequestSchema = null)
        {
        ...
        /// <param name="suspendRequestSchema">Contains the details of the request message.  (optional)</param>
        /// <returns>Task of SuspendResponseSchema</returns>
        public async System.Threading.Tasks.Task<SuspendResponseSchema> CreateSuspendAsync (SuspendRequestSchema suspendRequestSchema = null)
        {
        ...
        /// <param name="suspendRequestSchema">Contains the details of the request message.  (optional)</param>
        /// <returns>Task of ApiResponse (SuspendResponseSchema)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<SuspendResponseSchema>> CreateSuspendAsyncWithHttpInfo (SuspendRequestSchema suspendRequestSchema = null)
        {
