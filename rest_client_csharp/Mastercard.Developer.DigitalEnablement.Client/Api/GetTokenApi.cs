...
namespace Mastercard.Developer.DigitalEnablement.Client.Api
{
    ...
    public interface IGetTokenApi : IApiAccessor
    {
        ...
        ApiResponse<GetTokenResponseSchema> GetTokenWithHttpInfo (GetTokenRequestSchema getTokenRequestSchema = null);
        ...
        System.Threading.Tasks.Task<GetTokenResponseSchema> GetTokenAsync (GetTokenRequestSchema getTokenRequestSchema = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetTokenResponseSchema>> GetTokenAsyncWithHttpInfo (GetTokenRequestSchema getTokenRequestSchema = null);
    ...
    public partial class GetTokenApi : IGetTokenApi
    {
        ...
        /// <returns></returns>
        public GetTokenApi(Mastercard.Developer.DigitalEnablement.Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="getTokenRequestSchema">Contains the details of the request message.  (optional)</param>
        /// <returns>ApiResponse of GetTokenResponseSchema</returns>
        public ApiResponse< GetTokenResponseSchema > GetTokenWithHttpInfo (GetTokenRequestSchema getTokenRequestSchema = null)
        {
