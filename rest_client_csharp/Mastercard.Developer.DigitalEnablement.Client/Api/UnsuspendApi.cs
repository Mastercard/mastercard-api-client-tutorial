...
namespace Mastercard.Developer.DigitalEnablement.Client.Api
{
    ...
    public interface IUnsuspendApi : IApiAccessor
    {
        ...
        ApiResponse<UnSuspendResponseSchema> CreateUnsuspendWithHttpInfo (UnSuspendRequestSchema unsuspendRequestSchema = null);
        ...
        System.Threading.Tasks.Task<UnSuspendResponseSchema> CreateUnsuspendAsync (UnSuspendRequestSchema unsuspendRequestSchema = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<UnSuspendResponseSchema>> CreateUnsuspendAsyncWithHttpInfo (UnSuspendRequestSchema unsuspendRequestSchema = null);
    ...
    public partial class UnsuspendApi : IUnsuspendApi
    {
        ...
        /// <returns></returns>
        public UnsuspendApi(Mastercard.Developer.DigitalEnablement.Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="unsuspendRequestSchema">Contains the details of the request message.  (optional)</param>
        /// <returns>ApiResponse of UnSuspendResponseSchema</returns>
        public ApiResponse< UnSuspendResponseSchema > CreateUnsuspendWithHttpInfo (UnSuspendRequestSchema unsuspendRequestSchema = null)
        {
