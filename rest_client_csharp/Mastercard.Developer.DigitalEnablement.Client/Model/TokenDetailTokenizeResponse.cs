...
namespace Mastercard.Developer.DigitalEnablement.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenDetailTokenizeResponse :  IEquatable<TokenDetailTokenizeResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenDetailTokenizeResponse" /> class.
        /// </summary>
        ...
        public TokenDetailTokenizeResponse(string tokenUniqueReference = default(string), string publicKeyFingerprint = default(string), string encryptedKey = default(string), string oaepHashingAlgorithm = default(string), string iv = default(string), TokenDetailDataPAR encryptedData = default(TokenDetailDataPAR))
        {
        ...
        public TokenDetailDataPAR EncryptedData { get; set; }
        ...
        {
            return this.Equals(input as TokenDetailTokenizeResponse);
        }

        /// <summary>
        /// Returns true if TokenDetailTokenizeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenDetailTokenizeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenDetailTokenizeResponse input)
        {
            if (input == null)
                return false;
