...
namespace Mastercard.Developer.DigitalEnablement.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UnSuspendResponseSchema :  IEquatable<UnSuspendResponseSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnSuspendResponseSchema" /> class.
        /// </summary>
        ...
        public UnSuspendResponseSchema(string responseHost = default(string), string responseId = default(string), List<TokenForLCM> tokens = default(List<TokenForLCM>), string errorCode = default(string), string errorDescription = default(string), Error errors = default(Error))
        {
        ...
        {
            return this.Equals(input as UnSuspendResponseSchema);
        }

        /// <summary>
        /// Returns true if UnSuspendResponseSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of UnSuspendResponseSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnSuspendResponseSchema input)
        {
            if (input == null)
                return false;
