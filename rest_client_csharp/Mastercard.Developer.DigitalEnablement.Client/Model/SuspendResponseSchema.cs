...
namespace Mastercard.Developer.DigitalEnablement.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SuspendResponseSchema :  IEquatable<SuspendResponseSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuspendResponseSchema" /> class.
        /// </summary>
        ...
        public SuspendResponseSchema(string responseHost = default(string), string responseId = default(string), List<TokenForLCM> tokens = default(List<TokenForLCM>), string errorCode = default(string), string errorDescription = default(string), Error errors = default(Error))
        {
        ...
        {
            return this.Equals(input as SuspendResponseSchema);
        }

        /// <summary>
        /// Returns true if SuspendResponseSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of SuspendResponseSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SuspendResponseSchema input)
        {
            if (input == null)
                return false;
