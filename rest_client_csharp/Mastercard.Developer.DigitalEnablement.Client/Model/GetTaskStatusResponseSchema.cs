...
namespace Mastercard.Developer.DigitalEnablement.Client.Model
{
    ...
    public partial class GetTaskStatusResponseSchema :  IEquatable<GetTaskStatusResponseSchema>
    {
        ...
        public GetTaskStatusResponseSchema(string responseId = default(string), string responseHost = default(string), string status = default(string), string errorCode = default(string), string errorDescription = default(string), Error errors = default(Error))
        {
