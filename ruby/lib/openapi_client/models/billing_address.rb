...
module OpenapiClient
  class BillingAddress
    ...
    def list_invalid_properties
      ...
      if !@country_subdivision.nil? && @country_subdivision.to_s.length > 12
        invalid_properties.push('invalid value for "country_subdivision", the character length must be smaller than or equal to 12.')
      end

      if !@postal_code.nil? && @postal_code.to_s.length > 16
    ...
    def valid?
      ...
      return false if !@country_subdivision.nil? && @country_subdivision.to_s.length > 12
      return false if !@postal_code.nil? && @postal_code.to_s.length > 16
    ...
    # Custom attribute writer method with validation
    # @param [Object] country_subdivision Value to be assigned
    def country_subdivision=(country_subdivision)
      if !country_subdivision.nil? && country_subdivision.to_s.length > 12
        fail ArgumentError, 'invalid value for "country_subdivision", the character length must be smaller than or equal to 12.'
      end
    ...
    def hash
      [line1, line2, city, country_subdivision, postal_code, country].hash
    end
