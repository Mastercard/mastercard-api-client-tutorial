...
module OpenapiClient
  class TokenizeApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [TokenizeRequestSchema] :tokenize_request_schema A Tokenize request is used to digitize a PAN. 
    # @return [Array<(TokenizeResponseSchema, Integer, Hash)>] TokenizeResponseSchema data, response status code and response headers
    def create_tokenize_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'tokenize_request_schema'])

      # return_type
      return_type = opts[:debug_return_type] || 'TokenizeResponseSchema'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"TokenizeApi.create_tokenize",
