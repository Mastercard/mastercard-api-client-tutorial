...
module OpenapiClient
  class SearchTokensApi
    ...
    def search_tokens_with_http_info(opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'search_tokens_request_schema'])

      # return_type
      return_type = opts[:debug_return_type] || 'SearchTokensResponseSchema'

      # auth_names
      auth_names = opts[:debug_auth_names] || []

      new_options = opts.merge(
        :operation => :"SearchTokensApi.search_tokens",
