...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorsResponse', 'model/NotifyTokenUpdatedRequestSchema', 'model/NotifyTokenUpdatedResponseSchema'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorsResponse'), require('../model/NotifyTokenUpdatedRequestSchema'), require('../model/NotifyTokenUpdatedResponseSchema'));
  } else {
    // Browser globals (root is window)
    if (!root.MdesForMerchants) {
      root.MdesForMerchants = {};
    }
    root.MdesForMerchants.NotifyTokenUpdatedApi = factory(root.MdesForMerchants.ApiClient, root.MdesForMerchants.ErrorsResponse, root.MdesForMerchants.NotifyTokenUpdatedRequestSchema, root.MdesForMerchants.NotifyTokenUpdatedResponseSchema);
  }
}(this, function(ApiClient, ErrorsResponse, NotifyTokenUpdatedRequestSchema, NotifyTokenUpdatedResponseSchema) {
  'use strict';
