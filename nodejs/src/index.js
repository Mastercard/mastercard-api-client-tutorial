...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountHolderData', 'model/AccountHolderDataOutbound', 'model/AssetResponseSchema', 'model/AuthenticationMethods', 'model/BillingAddress', 'model/CardAccountDataInbound', 'model/CardAccountDataOutbound', 'model/DecisioningData', 'model/DeleteRequestSchema', 'model/DeleteResponseSchema', 'model/EncryptedPayload', 'model/EncryptedPayloadTransact', 'model/Error', 'model/ErrorsResponse', 'model/FundingAccountData', 'model/FundingAccountInfo', 'model/FundingAccountInfoEncryptedPayload', 'model/GetDigitalAssetsEncryptedData', 'model/GetDigitalAssetsRequestSchema', 'model/GetDigitalAssetsRequestSchemaEncryptedPayload', 'model/GetDigitalAssetsResponseSchema', 'model/GetTaskStatusRequestSchema', 'model/GetTaskStatusResponseSchema', 'model/GetTokenRequestSchema', 'model/GetTokenResponseSchema', 'model/MediaContent', 'model/NotifyTokenEncryptedPayload', 'model/NotifyTokenUpdatedRequestSchema', 'model/NotifyTokenUpdatedResponseSchema', 'model/PhoneNumber', 'model/ProductConfig', 'model/SearchTokensRequestSchema', 'model/SearchTokensResponseSchema', 'model/SuspendRequestSchema', 'model/SuspendResponseSchema', 'model/Token', 'model/TokenDetail', 'model/TokenDetailData', 'model/TokenDetailDataPAROnly', 'model/TokenDetailDataTCCOnly', 'model/TokenDetailPAROnly', 'model/TokenForLCM', 'model/TokenInfo', 'model/TokenizeRequestSchema', 'model/TokenizeResponseSchema', 'model/TransactEncryptedData', 'model/TransactError', 'model/TransactRequestSchema', 'model/TransactResponseSchema', 'model/UnSuspendRequestSchema', 'model/UnSuspendResponseSchema', 'api/DeleteApi', 'api/GetAssetApi', 'api/GetDigitalAssetsApi', 'api/GetTaskStatusApi', 'api/GetTokenApi', 'api/NotifyTokenUpdatedApi', 'api/SearchTokensApi', 'api/SuspendApi', 'api/TokenizeApi', 'api/TransactApi', 'api/UnsuspendApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AccountHolderData'), require('./model/AccountHolderDataOutbound'), require('./model/AssetResponseSchema'), require('./model/AuthenticationMethods'), require('./model/BillingAddress'), require('./model/CardAccountDataInbound'), require('./model/CardAccountDataOutbound'), require('./model/DecisioningData'), require('./model/DeleteRequestSchema'), require('./model/DeleteResponseSchema'), require('./model/EncryptedPayload'), require('./model/EncryptedPayloadTransact'), require('./model/Error'), require('./model/ErrorsResponse'), require('./model/FundingAccountData'), require('./model/FundingAccountInfo'), require('./model/FundingAccountInfoEncryptedPayload'), require('./model/GetDigitalAssetsEncryptedData'), require('./model/GetDigitalAssetsRequestSchema'), require('./model/GetDigitalAssetsRequestSchemaEncryptedPayload'), require('./model/GetDigitalAssetsResponseSchema'), require('./model/GetTaskStatusRequestSchema'), require('./model/GetTaskStatusResponseSchema'), require('./model/GetTokenRequestSchema'), require('./model/GetTokenResponseSchema'), require('./model/MediaContent'), require('./model/NotifyTokenEncryptedPayload'), require('./model/NotifyTokenUpdatedRequestSchema'), require('./model/NotifyTokenUpdatedResponseSchema'), require('./model/PhoneNumber'), require('./model/ProductConfig'), require('./model/SearchTokensRequestSchema'), require('./model/SearchTokensResponseSchema'), require('./model/SuspendRequestSchema'), require('./model/SuspendResponseSchema'), require('./model/Token'), require('./model/TokenDetail'), require('./model/TokenDetailData'), require('./model/TokenDetailDataPAROnly'), require('./model/TokenDetailDataTCCOnly'), require('./model/TokenDetailPAROnly'), require('./model/TokenForLCM'), require('./model/TokenInfo'), require('./model/TokenizeRequestSchema'), require('./model/TokenizeResponseSchema'), require('./model/TransactEncryptedData'), require('./model/TransactError'), require('./model/TransactRequestSchema'), require('./model/TransactResponseSchema'), require('./model/UnSuspendRequestSchema'), require('./model/UnSuspendResponseSchema'), require('./api/DeleteApi'), require('./api/GetAssetApi'), require('./api/GetDigitalAssetsApi'), require('./api/GetTaskStatusApi'), require('./api/GetTokenApi'), require('./api/NotifyTokenUpdatedApi'), require('./api/SearchTokensApi'), require('./api/SuspendApi'), require('./api/TokenizeApi'), require('./api/TransactApi'), require('./api/UnsuspendApi'));
  }
}(function(ApiClient, AccountHolderData, AccountHolderDataOutbound, AssetResponseSchema, AuthenticationMethods, BillingAddress, CardAccountDataInbound, CardAccountDataOutbound, DecisioningData, DeleteRequestSchema, DeleteResponseSchema, EncryptedPayload, EncryptedPayloadTransact, Error, ErrorsResponse, FundingAccountData, FundingAccountInfo, FundingAccountInfoEncryptedPayload, GetDigitalAssetsEncryptedData, GetDigitalAssetsRequestSchema, GetDigitalAssetsRequestSchemaEncryptedPayload, GetDigitalAssetsResponseSchema, GetTaskStatusRequestSchema, GetTaskStatusResponseSchema, GetTokenRequestSchema, GetTokenResponseSchema, MediaContent, NotifyTokenEncryptedPayload, NotifyTokenUpdatedRequestSchema, NotifyTokenUpdatedResponseSchema, PhoneNumber, ProductConfig, SearchTokensRequestSchema, SearchTokensResponseSchema, SuspendRequestSchema, SuspendResponseSchema, Token, TokenDetail, TokenDetailData, TokenDetailDataPAROnly, TokenDetailDataTCCOnly, TokenDetailPAROnly, TokenForLCM, TokenInfo, TokenizeRequestSchema, TokenizeResponseSchema, TransactEncryptedData, TransactError, TransactRequestSchema, TransactResponseSchema, UnSuspendRequestSchema, UnSuspendResponseSchema, DeleteApi, GetAssetApi, GetDigitalAssetsApi, GetTaskStatusApi, GetTokenApi, NotifyTokenUpdatedApi, SearchTokensApi, SuspendApi, TokenizeApi, TransactApi, UnsuspendApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The GetDigitalAssetsEncryptedData model constructor.
     * @property {module:model/GetDigitalAssetsEncryptedData}
     */
    GetDigitalAssetsEncryptedData: GetDigitalAssetsEncryptedData,
    /**
     * The GetDigitalAssetsRequestSchema model constructor.
     * @property {module:model/GetDigitalAssetsRequestSchema}
     */
    GetDigitalAssetsRequestSchema: GetDigitalAssetsRequestSchema,
    /**
     * The GetDigitalAssetsRequestSchemaEncryptedPayload model constructor.
     * @property {module:model/GetDigitalAssetsRequestSchemaEncryptedPayload}
     */
    GetDigitalAssetsRequestSchemaEncryptedPayload: GetDigitalAssetsRequestSchemaEncryptedPayload,
    /**
     * The GetDigitalAssetsResponseSchema model constructor.
     * @property {module:model/GetDigitalAssetsResponseSchema}
     */
    GetDigitalAssetsResponseSchema: GetDigitalAssetsResponseSchema,
    /**
    ...
    /**
     * The TokenDetailDataTCCOnly model constructor.
     * @property {module:model/TokenDetailDataTCCOnly}
     */
    TokenDetailDataTCCOnly: TokenDetailDataTCCOnly,
    /**
    ...
    /**
     * The GetDigitalAssetsApi service constructor.
     * @property {module:api/GetDigitalAssetsApi}
     */
    GetDigitalAssetsApi: GetDigitalAssetsApi,
    /**
