...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Error', 'model/ProductConfig', 'model/TokenInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Error'), require('./ProductConfig'), require('./TokenInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.MdesForMerchants) {
      root.MdesForMerchants = {};
    }
    root.MdesForMerchants.Token = factory(root.MdesForMerchants.ApiClient, root.MdesForMerchants.Error, root.MdesForMerchants.ProductConfig, root.MdesForMerchants.TokenInfo);
  }
}(this, function(ApiClient, Error, ProductConfig, TokenInfo) {
  'use strict';
