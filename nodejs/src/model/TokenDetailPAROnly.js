...
class TokenDetailPAROnly {
    ...
    /**
     * Validates the JSON data with respect to <code>TokenDetailPAROnly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokenDetailPAROnly</code>.
     */
    static validateJSON(data) {
        ...
        if (data['encryptedData']) { // data not null
          TokenDetailDataPAROnly.validateJSON(data['encryptedData']);
        }
