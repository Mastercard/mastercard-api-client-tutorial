...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AuthenticationMethods', 'model/Error', 'model/ProductConfig', 'model/TokenDetail', 'model/TokenInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AuthenticationMethods'), require('./Error'), require('./ProductConfig'), require('./TokenDetail'), require('./TokenInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.MdesForMerchants) {
      root.MdesForMerchants = {};
    }
    root.MdesForMerchants.TokenizeResponseSchema = factory(root.MdesForMerchants.ApiClient, root.MdesForMerchants.AuthenticationMethods, root.MdesForMerchants.Error, root.MdesForMerchants.ProductConfig, root.MdesForMerchants.TokenDetail, root.MdesForMerchants.TokenInfo);
  }
}(this, function(ApiClient, AuthenticationMethods, Error, ProductConfig, TokenDetail, TokenInfo) {
  'use strict';
