...
class GatewayErrorsResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>GatewayErrorsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GatewayErrorsResponse</code>.
     */
    static validateJSON(data) {
        // validate the optional field `Errors`
        if (data['Errors']) { // data not null
          GatewayErrorsSchema.validateJSON(data['Errors']);
        }
