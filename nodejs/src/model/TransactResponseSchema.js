...
class TransactResponseSchema {
    ...
    /**
     * Validates the JSON data with respect to <code>TransactResponseSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactResponseSchema</code>.
     */
    static validateJSON(data) {
        ...
        if (data['encryptedPayload']) { // data not null
          EncryptedPayloadTransact.validateJSON(data['encryptedPayload']);
        }
