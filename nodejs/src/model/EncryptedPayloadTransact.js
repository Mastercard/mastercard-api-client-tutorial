...
class EncryptedPayloadTransact {
    ...
    /**
     * Validates the JSON data with respect to <code>EncryptedPayloadTransact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EncryptedPayloadTransact</code>.
     */
    static validateJSON(data) {
        ...
        if (data['encryptedData']) { // data not null
          TransactEncryptedData.validateJSON(data['encryptedData']);
        }
