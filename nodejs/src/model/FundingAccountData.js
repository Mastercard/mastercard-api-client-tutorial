...
class FundingAccountData {
    ...
    /**
     * Validates the JSON data with respect to <code>FundingAccountData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FundingAccountData</code>.
     */
    static validateJSON(data) {
        // validate the optional field `cardAccountData`
        if (data['cardAccountData']) { // data not null
          CardAccountDataInbound.validateJSON(data['cardAccountData']);
        }
        // validate the optional field `accountHolderData`
        if (data['accountHolderData']) { // data not null
          AccountHolderData.validateJSON(data['accountHolderData']);
        }
