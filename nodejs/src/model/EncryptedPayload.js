...
class EncryptedPayload {
    ...
    /**
     * Validates the JSON data with respect to <code>EncryptedPayload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EncryptedPayload</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EncryptedPayload.RequiredProperties) {
        ...
        if (data['encryptedData']) { // data not null
          NotifyTokenEncryptedPayload.validateJSON(data['encryptedData']);
        }
...
EncryptedPayload.RequiredProperties = ["publicKeyFingerprint", "encryptedKey", "encryptedData"];
