...
class TokenDetailGetTokenOnly {
    ...
    /**
     * Validates the JSON data with respect to <code>TokenDetailGetTokenOnly</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokenDetailGetTokenOnly</code>.
     */
    static validateJSON(data) {
        ...
        if (data['encryptedData']) { // data not null
          TokenDetailDataGetTokenOnly.validateJSON(data['encryptedData']);
        }
 ...
 * @member {String} iv
 */
TokenDetailGetTokenOnly.prototype['iv'] = undefined;
