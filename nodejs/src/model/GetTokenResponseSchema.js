...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Token', 'model/TokenDetailGetTokenOnly'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Token'), require('./TokenDetailGetTokenOnly'));
  } else {
    // Browser globals (root is window)
    if (!root.MdesForMerchants) {
      root.MdesForMerchants = {};
    }
    root.MdesForMerchants.GetTokenResponseSchema = factory(root.MdesForMerchants.ApiClient, root.MdesForMerchants.Token, root.MdesForMerchants.TokenDetailGetTokenOnly);
  }
}(this, function(ApiClient, Token, TokenDetailGetTokenOnly) {
  'use strict';
