...
import TokenForGetToken from './TokenForGetToken';
...
class GetTokenResponseSchema {
    ...
    /**
     * Validates the JSON data with respect to <code>GetTokenResponseSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTokenResponseSchema</code>.
     */
    static validateJSON(data) {
        ...
        if (data['token']) { // data not null
          TokenForGetToken.validateJSON(data['token']);
        }
        // validate the optional field `tokenDetail`
        if (data['tokenDetail']) { // data not null
          TokenDetailGetTokenOnly.validateJSON(data['tokenDetail']);
        }
