...
class NotifyTokenUpdatedRequestSchema {
    ...
    /**
     * Validates the JSON data with respect to <code>NotifyTokenUpdatedRequestSchema</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NotifyTokenUpdatedRequestSchema</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NotifyTokenUpdatedRequestSchema.RequiredProperties) {
        ...
        if (data['encryptedPayload']) { // data not null
          EncryptedPayload.validateJSON(data['encryptedPayload']);
        }
...
NotifyTokenUpdatedRequestSchema.RequiredProperties = ["responseHost", "requestId", "encryptedPayload"];
