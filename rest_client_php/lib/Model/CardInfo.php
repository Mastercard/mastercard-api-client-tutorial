...
class CardInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'iv' => 'string',
        'encrypted_data' => '\OpenAPI\Client\Model\CardInfoData'
    ];
     ...
     *
     * @param string|null $public_key_fingerprint The fingerprint of the public key used to encrypt the ephemeral AES key. Required if encryptedData is present.<br>     __Max Length:64__ Hex-encoded data (case-insensitive).
     *
     * @return $this
     */
     ...
     *
     * @param string|null $oaep_hashing_algorithm Hashing algorithm used with the OAEP scheme. Must be either SHA256 or SHA512.     __Max Length:6__
     *
     * @return $this
     */
     ...
     * Sets iv
     *
     * @param string|null $iv It is recommended to supply a random initialization vector when encrypting the data using the one-time use AES key. Must be exactly 16 bytes (32 character hex string) to match the block size. Hex-encoded data (case-insensitive).  <br>__Max Length:32__
     *
     * @return $this
     */
     ...
     * Gets encrypted_data
     *
     * @return \OpenAPI\Client\Model\CardInfoData|null
     */
     ...
     * Sets encrypted_data
     *
     * @param \OpenAPI\Client\Model\CardInfoData|null $encrypted_data encrypted_data
     *
     * @return $this
     */
