...
class TokenizeRequestSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TokenizeRequestSchema';
    ...
    protected static $swaggerTypes = [
        ...
        'decisioning_data' => '\Swagger\Client\Model\DecisioningData'
    ];
     ...
     * Sets response_host
     *
     * @param string $response_host \"The host that originated the request. Future calls in the same conversation may be routed to this host. Must be provided as: host[:port][/contextRoot] Where port and contextRoot are optional. If contextRoot is not provided, the default (per the URL Scheme) is assumed and must be used.\"
     *
     * @return $this
     */
     ...
     *
     * @param string $consumer_language Language preference selected by the consumer. Formatted as an ISO- 639-1 two-letter language code.    __Max Length:2__
     *
     * @return $this
     */
     ...
     *
     * @param string $tokenization_authentication_value The Tokenization Authentication Value (TAV) as cryptographically signed by the Issuer to authorize this digitization request.      __Max Length:2048__
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\DecisioningData
     */
     ...
     *
     * @param \Swagger\Client\Model\DecisioningData $decisioning_data decisioning_data
     *
     * @return $this
     */
