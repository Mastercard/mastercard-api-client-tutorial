 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeleteRequestSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DeleteRequestSchema';
     ...
     * Sets caused_by
     *
     * @param string $caused_by Who or what caused the Token to be deleted. Must be either the 'CARDHOLDER' (operation requested by the Cardholder) or 'TOKEN_REQUESTOR' (operation requested by the token requestor).    __Max Length:64__
     *
     * @return $this
     */
     ...
     * Sets reason_code
     *
     * @param string $reason_code The reason for the action to be deleted. Must be one of 'SUSPECTED_FRAUD' (suspected fraudulent token transactions), 'OTHER' (Other - default used if value not provided).     __Max Length:64__
     *
     * @return $this
     */
