...
class FundingAccountInfoEncryptedPayload implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'fundingAccountInfo-EncryptedPayload';
    ...
    protected static $swaggerTypes = [
        ...
        'iv' => 'string',
        'encrypted_data' => '\Swagger\Client\Model\FundingAccountData'
    ];
     ...
     *
     * @param string $public_key_fingerprint The fingerprint of the public key used to encrypt the ephemeral AES key.<br> __Max Length: 64__
     *
     * @return $this
     */
     ...
     * Sets encrypted_key
     *
     * @param string $encrypted_key One-time use AES key encrypted by the MasterCard public key (as identified by publicKeyFingerprint) using the OAEP or PKCS#1 v1.5 scheme (depending on the value of oaepHashingAlgorithm. <br> __Max Length: 512__
     *
     * @return $this
     */
     ...
     * Sets iv
     *
     * @param string $iv The initialization vector used when encrypting data using the one-time use AES key. Must be exactly 16 bytes (32 character hex string) to match the block size. If not present, an IV of zero is assumed.  <br>__Length: 32__
     *
     * @return $this
     */
     ...
     * Gets encrypted_data
     *
     * @return \Swagger\Client\Model\FundingAccountData
     */
     ...
     * Sets encrypted_data
     *
     * @param \Swagger\Client\Model\FundingAccountData $encrypted_data encrypted_data
     *
     * @return $this
     */
