...
class TransactRequestSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransactRequestSchema';
     ...
     * Sets amount
     *
     * @param string $amount Transaction amount to be authorized. Note that refund transactions are not supported � this value must be a positive amount and can contain up to 12 digits, inclusive of any digits in the currency exponent.     __Max Length:13__
     *
     * @return $this
     */
     ...
     * Sets currency_code
     *
     * @param string $currency_code The transaction currency. Expressed as a 3-character ISO 4217 currency code.
     *
     * @return $this
     */
