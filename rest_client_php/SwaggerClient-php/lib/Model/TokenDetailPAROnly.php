 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TokenDetailPAROnly implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tokenDetail_PAR_Only';
    ...
    protected static $swaggerTypes = [
        ...
        'iv' => 'string',
        'encrypted_data' => '\Swagger\Client\Model\TokenDetailDataPAROnly'
    ];
     ...
     *
     * @param string $token_unique_reference Globally unique identifier for the Token, as assigned by MDES.<br>     __Max Length:64__
     *
     * @return $this
     */
     ...
     *
     * @param string $public_key_fingerprint The certificate fingerprint identifying the public key used to encrypt the ephemeral AES key.<br>     __Max Length:64__ Hex-encoded data (case-insensitive).
     *
     * @return $this
     */
     ...
     *
     * @param string $oaep_hashing_algorithm Hashing algorithm used with the OAEP scheme. If omitted, then the RSA Encryption Standard PKCS #1 v1.5 will be used. Must be either 'SHA256' (Use the SHA-256 algorithm) or 'SHA512' (Use the SHA-512 algorithm).<br>     __Max Length:6__
     *
     * @return $this
     */
     ...
     * Sets iv
     *
     * @param string $iv It is recommended to supply a random initialization vector when encrypting the data using the one-time use AES key. Must be exactly 16 bytes (32 character hex string) to match the block size. Hex-encoded data (case-insensitive).  __Max Length:32__
     *
     * @return $this
     */
     ...
     * Gets encrypted_data
     *
     * @return \Swagger\Client\Model\TokenDetailDataPAROnly
     */
     ...
     * Sets encrypted_data
     *
     * @param \Swagger\Client\Model\TokenDetailDataPAROnly $encrypted_data encrypted_data
     *
     * @return $this
     */
