...
/**
 * TokenDetailTokenizeResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TokenDetailTokenizeResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tokenDetail_tokenize_response';
    ...
    protected static $swaggerTypes = [
        ...
        'iv' => 'string',
        'encrypted_data' => '\Swagger\Client\Model\TokenDetailDataPAR'
    ];
     ...
     * Sets iv
     *
     * @param string $iv It is recommended to supply a random initialization vector when encrypting the data using the one-time use AES key. Must be exactly 16 bytes (32 character hex string) to match the block size. Hex-encoded data (case-insensitive).
     *
     * @return $this
     */
     ...
     * Gets encrypted_data
     *
     * @return \Swagger\Client\Model\TokenDetailDataPAR
     */
     ...
     * Sets encrypted_data
     *
     * @param \Swagger\Client\Model\TokenDetailDataPAR $encrypted_data encrypted_data
     *
     * @return $this
     */
