...
class TokenDetailData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tokenDetailData';
     ...
     * Sets token_number
     *
     * @param string $token_number Globally unique identifier for the Token, as assigned by MDES.     __Max Length:64__
     *
     * @return $this
     */
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month The expiry month for the account.
     *
     * @return $this
     */
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year The expiry year for the account.
     *
     * @return $this
     */
     ...
     *
     * @param string $payment_account_reference \"The unique account reference assigned to the PAN. Conditionally returned if the Token Requestor has opted to receive PAR and providing PAR is assigned by Mastercard or the Issuer provides PAR in the authorization message response.    __Max Length:__ - 29\"
     *
     * @return $this
     */
