 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EncryptedPayload implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'encryptedPayload';
    ...
    protected static $swaggerTypes = [
        ...
        'iv' => 'string',
        'encrypted_data' => '\Swagger\Client\Model\NotifyTokenEncryptedPayload'
    ];
     ...
     *
     * @param string $public_key_fingerprint The fingerprint of the public key used to encrypt the ephemeral AES key.     __Max Length:64__
     *
     * @return $this
     */
     ...
     * Sets encrypted_key
     *
     * @param string $encrypted_key One-time use AES key encrypted by the MasterCard public key (as identified by publicKeyFingerprint) using the OAEP or PKCS#1 v1.5 scheme (depending on the value of oaepHashingAlgorithm.     __Max Length:512__
     *
     * @return $this
     */
     ...
     *
     * @param string $oaep_hashing_algorithm Hashing algorithm used with the OAEP scheme. Must be either SHA256 or SHA512.
     *
     * @return $this
     */
     ...
     * Sets iv
     *
     * @param string $iv The initialization vector used when encrypting data using the one-time use AES key. Must be exactly 16 bytes (32 character hex string) to match the block size. If not present, an IV of zero is assumed. Length - 32.
     *
     * @return $this
     */
     ...
     * Gets encrypted_data
     *
     * @return \Swagger\Client\Model\NotifyTokenEncryptedPayload
     */
     ...
     * Sets encrypted_data
     *
     * @param \Swagger\Client\Model\NotifyTokenEncryptedPayload $encrypted_data encrypted_data
     *
     * @return $this
     */
