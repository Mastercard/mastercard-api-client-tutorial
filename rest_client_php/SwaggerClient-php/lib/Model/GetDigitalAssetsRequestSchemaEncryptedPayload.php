...
/**
 * GetDigitalAssetsRequestSchemaEncryptedPayload Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetDigitalAssetsRequestSchemaEncryptedPayload implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetDigitalAssetsRequestSchema_encryptedPayload';
    ...
    protected static $swaggerTypes = [
        ...
        'encrypted_data' => '\Swagger\Client\Model\GetDigitalAssetsEncryptedData'
    ];
     ...
     *
     * @param string $public_key_fingerprint The fingerpint of the public key used to encrypt the ephemeral AES key. __Max Length:64__
     *
     * @return $this
     */
     ...
     * Sets encrypted_key
     *
     * @param string $encrypted_key One-time use AES key encrypted by the Mastercard public key (as identified by publicKeyFingerprint) using the OEAP or PKCS#1 v1.5 scheme (depending on the value of oeapHashingAlgorithm.) __Max Length:512__
     *
     * @return $this
     */
     ...
     * Gets encrypted_data
     *
     * @return \Swagger\Client\Model\GetDigitalAssetsEncryptedData
     */
     ...
     * Sets encrypted_data
     *
     * @param \Swagger\Client\Model\GetDigitalAssetsEncryptedData $encrypted_data encrypted_data
     *
     * @return $this
     */
