...
class GetTokenApi
{
     ...
     *
     * @param  \Swagger\Client\Model\GetTokenRequestSchema $get_token_request_schema Contains the details of the request message. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GetTokenResponseSchema
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GetTokenResponseSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTokenWithHttpInfo($get_token_request_schema = null)
    {
        $returnType = '\Swagger\Client\Model\GetTokenResponseSchema';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\GetTokenResponseSchema',
