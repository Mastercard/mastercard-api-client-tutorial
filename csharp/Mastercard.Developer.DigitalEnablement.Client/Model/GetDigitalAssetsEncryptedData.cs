...
namespace Mastercard.Developer.DigitalEnablement.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDigitalAssetsEncryptedData :  IEquatable<GetDigitalAssetsEncryptedData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDigitalAssetsEncryptedData" /> class.
        /// </summary>
        ...
        public GetDigitalAssetsEncryptedData(string accountNumber = default(string))
        {
        ...
        {
            return this.Equals(input as GetDigitalAssetsEncryptedData);
        }

        /// <summary>
        /// Returns true if GetDigitalAssetsEncryptedData instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDigitalAssetsEncryptedData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDigitalAssetsEncryptedData input)
        {
            if (input == null)
                return false;
