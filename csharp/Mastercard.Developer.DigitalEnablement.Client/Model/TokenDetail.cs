...
namespace Mastercard.Developer.DigitalEnablement.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TokenDetail :  IEquatable<TokenDetail>
    {
        /// <summary>
        ...
        public TokenDetail(string tokenUniqueReference = default(string), string publicKeyFingerprint = default(string), string encryptedKey = default(string), string oaepHashingAlgorithm = default(string), string iv = default(string), TokenDetailDataTCCOnly encryptedData = default(TokenDetailDataTCCOnly))
        {
        ...
        public TokenDetailDataTCCOnly EncryptedData { get; set; }
