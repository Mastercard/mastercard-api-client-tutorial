...
namespace Mastercard.Developer.DigitalEnablement.Client.Model
{
    ...
    public partial class TransactRequestSchema :  IEquatable<TransactRequestSchema>
    {
        ...
        /// <param name="unpredictableNumber">__CONDITIONAL__&lt;br&gt;HEX Encoded data (case sensitive) provided by the merchant to provide variability and uniqueness to the generation of a cryptogram.  Required if the shouldGenerateUnpredictableNumber flag is not set during on-boarding.&lt;br&gt; __Length:8__           .</param>
        ...
        [DataMember(Name="dsrpType", EmitDefaultValue=true)]
        ...
        /// </summary>
        /// <value>__CONDITIONAL__&lt;br&gt;HEX Encoded data (case sensitive) provided by the merchant to provide variability and uniqueness to the generation of a cryptogram.  Required if the shouldGenerateUnpredictableNumber flag is not set during on-boarding.&lt;br&gt; __Length:8__           </value>
