...
namespace Mastercard.Developer.DigitalEnablement.Client.Model
{
    ...
    public partial class Token :  IEquatable<Token>
    {
        ...
        public Token(string tokenUniqueReference = default(string), string status = default(string), List<string> suspendedBy = default(List<string>), string statusTimestamp = default(string), ProductConfig productConfig = default(ProductConfig), TokenInfo tokenInfo = default(TokenInfo), string errorCode = default(string), string errorDescription = default(string), List<Error> errors = default(List<Error>))
        {
