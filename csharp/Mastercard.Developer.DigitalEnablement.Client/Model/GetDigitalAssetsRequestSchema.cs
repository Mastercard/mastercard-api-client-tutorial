...
namespace Mastercard.Developer.DigitalEnablement.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetDigitalAssetsRequestSchema :  IEquatable<GetDigitalAssetsRequestSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDigitalAssetsRequestSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetDigitalAssetsRequestSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDigitalAssetsRequestSchema" /> class.
        /// </summary>
        ...
        public GetDigitalAssetsRequestSchema(string responseHost = default(string), string requestId = default(string), GetDigitalAssetsRequestSchemaEncryptedPayload encryptedPayload = default(GetDigitalAssetsRequestSchemaEncryptedPayload))
        {
            // to ensure "responseHost" is required (not null)
            if (responseHost == null)
            {
                throw new InvalidDataException("responseHost is a required property for GetDigitalAssetsRequestSchema and cannot be null");
            }
            else
            {
            ...
            if (requestId == null)
            {
                throw new InvalidDataException("requestId is a required property for GetDigitalAssetsRequestSchema and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("encryptedPayload is a required property for GetDigitalAssetsRequestSchema and cannot be null");
            }
            else
            {
        ...
        public GetDigitalAssetsRequestSchemaEncryptedPayload EncryptedPayload { get; set; }
        ...
        {
            return this.Equals(input as GetDigitalAssetsRequestSchema);
        }

        /// <summary>
        /// Returns true if GetDigitalAssetsRequestSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of GetDigitalAssetsRequestSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetDigitalAssetsRequestSchema input)
        {
            if (input == null)
                return false;
