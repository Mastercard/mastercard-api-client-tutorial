...
namespace Mastercard.Developer.DigitalEnablement.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SuspendRequestSchema :  IEquatable<SuspendRequestSchema>
    {
        /// <summary>
        ...
        public SuspendRequestSchema(string responseHost = default(string), string requestId = default(string), string paymentAppInstanceId = default(string), List<string> tokenUniqueReferences = default(List<string>), string causedBy = default(string), string reason = default(string), string reasonCode = default(string))
        {
            ...
            if (requestId == null)
            {
                throw new InvalidDataException("requestId is a required property for SuspendRequestSchema and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("tokenUniqueReferences is a required property for SuspendRequestSchema and cannot be null");
            }
            else
            {
            ...
            if (causedBy == null)
            {
                throw new InvalidDataException("causedBy is a required property for SuspendRequestSchema and cannot be null");
            }
            else
            {
            ...
            if (reasonCode == null)
            {
                throw new InvalidDataException("reasonCode is a required property for SuspendRequestSchema and cannot be null");
            }
            else
            {
