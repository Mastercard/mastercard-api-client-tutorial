...
namespace Acme.App.MastercardApi.Client.Api
{
    ...
    public interface IUnsuspendApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<UnSuspendResponseSchema> CreateUnsuspendAsync(UnSuspendRequestSchema unSuspendRequestSchema = default(UnSuspendRequestSchema), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<UnSuspendResponseSchema>> CreateUnsuspendWithHttpInfoAsync(UnSuspendRequestSchema unSuspendRequestSchema = default(UnSuspendRequestSchema), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class UnsuspendApi : IUnsuspendApi
    {
        ...
        /// <param name="unSuspendRequestSchema">Contains the details of the request message.  (optional)</param>
        /// <returns>ApiResponse of UnSuspendResponseSchema</returns>
        public Acme.App.MastercardApi.Client.Client.ApiResponse<UnSuspendResponseSchema> CreateUnsuspendWithHttpInfo(UnSuspendRequestSchema unSuspendRequestSchema = default(UnSuspendRequestSchema))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UnSuspendResponseSchema</returns>
        public async System.Threading.Tasks.Task<UnSuspendResponseSchema> CreateUnsuspendAsync(UnSuspendRequestSchema unSuspendRequestSchema = default(UnSuspendRequestSchema), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Acme.App.MastercardApi.Client.Client.ApiResponse<UnSuspendResponseSchema> localVarResponse = await CreateUnsuspendWithHttpInfoAsync(unSuspendRequestSchema, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UnSuspendResponseSchema)</returns>
        public async System.Threading.Tasks.Task<Acme.App.MastercardApi.Client.Client.ApiResponse<UnSuspendResponseSchema>> CreateUnsuspendWithHttpInfoAsync(UnSuspendRequestSchema unSuspendRequestSchema = default(UnSuspendRequestSchema), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
