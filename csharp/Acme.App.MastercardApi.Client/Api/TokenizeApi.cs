...
namespace Acme.App.MastercardApi.Client.Api
{
    ...
    public partial class TokenizeApi : ITokenizeApi
    {
        ...
        /// <returns></returns>
        public TokenizeApi(Acme.App.MastercardApi.Client.Client.Configuration configuration)
        {
        ...
        public TokenizeApi(Acme.App.MastercardApi.Client.Client.ISynchronousClient client, Acme.App.MastercardApi.Client.Client.IAsynchronousClient asyncClient, Acme.App.MastercardApi.Client.Client.IReadableConfiguration configuration)
        {
