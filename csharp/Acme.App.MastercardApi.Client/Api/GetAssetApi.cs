...
namespace Acme.App.MastercardApi.Client.Api
{
    ...
    public interface IGetAssetApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AssetResponseSchema> GetAssetAsync(string assetId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<AssetResponseSchema>> GetAssetWithHttpInfoAsync(string assetId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class GetAssetApi : IGetAssetApi
    {
        ...
        /// <param name="assetId">An Asset ID corresponds to an individual Digital Asset. Digital Assets are returned as part of the Product Configuration from the Tokenize Response. The Asset ID itself is supplied as a Get request in the form of https://{INSERT ENVIRONMENT URL HERE}/mdes/assets/static/1/0/asset/{AssetID} - See JSON examples for details.  </param>
        /// <returns>ApiResponse of AssetResponseSchema</returns>
        public Acme.App.MastercardApi.Client.Client.ApiResponse<AssetResponseSchema> GetAssetWithHttpInfo(string assetId)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of AssetResponseSchema</returns>
        public async System.Threading.Tasks.Task<AssetResponseSchema> GetAssetAsync(string assetId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Acme.App.MastercardApi.Client.Client.ApiResponse<AssetResponseSchema> localVarResponse = await GetAssetWithHttpInfoAsync(assetId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (AssetResponseSchema)</returns>
        public async System.Threading.Tasks.Task<Acme.App.MastercardApi.Client.Client.ApiResponse<AssetResponseSchema>> GetAssetWithHttpInfoAsync(string assetId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'assetId' is set
            if (assetId == null)
                throw new Acme.App.MastercardApi.Client.Client.ApiException(400, "Missing required parameter 'assetId' when calling GetAssetApi->GetAsset");
