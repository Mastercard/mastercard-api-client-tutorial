...
namespace Acme.App.MastercardApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SuspendResponseSchema")]
    public partial class SuspendResponseSchema : IEquatable<SuspendResponseSchema>, IValidatableObject
    {
        /// <summary>
        ...
        public SuspendResponseSchema(string responseHost = default(string), string responseId = default(string), List<TokenForLCM> tokens = default(List<TokenForLCM>))
        {
