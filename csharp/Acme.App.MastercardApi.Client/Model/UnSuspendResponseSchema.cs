...
namespace Acme.App.MastercardApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnSuspendResponseSchema")]
    public partial class UnSuspendResponseSchema : IEquatable<UnSuspendResponseSchema>, IValidatableObject
    {
        /// <summary>
        ...
        public UnSuspendResponseSchema(string responseHost = default(string), string responseId = default(string), List<TokenForLCM> tokens = default(List<TokenForLCM>))
        {
