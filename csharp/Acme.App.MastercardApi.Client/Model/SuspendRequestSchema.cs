...
namespace Acme.App.MastercardApi.Client.Model
{
    ...
    public partial class SuspendRequestSchema : IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="causedBy">Who or what caused the Token to be suspended. Must be either the &#39;CARDHOLDER&#39; (operation requested by the Cardholder) or &#39;TOKEN_REQUESTOR&#39; (operation requested by the token requestor).  (required).</param>
        /// <param name="reason">Free form reason why the Tokens are being suspended. .</param>
        /// <param name="reasonCode">The reason for the action to be suspended. Must be one of &#39;SUSPECTED_FRAUD&#39; (suspected fraudulent token transactions), &#39;OTHER&#39; (Other - default used if value not provided).  (required).</param>
        public SuspendRequestSchema(string responseHost = default(string), string requestId = default(string), string paymentAppInstanceId = default(string), List<string> tokenUniqueReferences = default(List<string>), string causedBy = default(string), string reason = default(string), string reasonCode = default(string))
        {
            ...
            if (requestId == null)
            {
                throw new ArgumentNullException("requestId is a required property for SuspendRequestSchema and cannot be null");
            }
            this.RequestId = requestId;
            // to ensure "tokenUniqueReferences" is required (not null)
            if (tokenUniqueReferences == null)
            {
                throw new ArgumentNullException("tokenUniqueReferences is a required property for SuspendRequestSchema and cannot be null");
            }
            this.TokenUniqueReferences = tokenUniqueReferences;
            // to ensure "causedBy" is required (not null)
            if (causedBy == null)
            {
                throw new ArgumentNullException("causedBy is a required property for SuspendRequestSchema and cannot be null");
            }
            this.CausedBy = causedBy;
            // to ensure "reasonCode" is required (not null)
            if (reasonCode == null)
            {
                throw new ArgumentNullException("reasonCode is a required property for SuspendRequestSchema and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Who or what caused the Token to be suspended. Must be either the &#39;CARDHOLDER&#39; (operation requested by the Cardholder) or &#39;TOKEN_REQUESTOR&#39; (operation requested by the token requestor). </value>
        ...
        /// </summary>
        /// <value>The reason for the action to be suspended. Must be one of &#39;SUSPECTED_FRAUD&#39; (suspected fraudulent token transactions), &#39;OTHER&#39; (Other - default used if value not provided). </value>
