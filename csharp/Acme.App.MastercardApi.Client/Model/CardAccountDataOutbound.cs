...
namespace Acme.App.MastercardApi.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CardAccountDataOutbound :  IEquatable<CardAccountDataOutbound>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CardAccountDataOutbound" /> class.
        /// </summary>
        /// <param name="accountNumber"> The account number of the credit or debit card.   __Min Length:9__&lt;br&gt;  __Max Length:19__ .</param>
        /// <param name="expiryMonth">  The expiry month for the account. Two numeric digits must be supplied.   __Format: MM__&lt;br&gt; __Exact Length:2__ .</param>
        /// <param name="expiryYear">__(Required as minimum for Tokenization)__  The expiry year for the account. __Format: YY__ &lt;br&gt; __Exact Length:2__ .</param>
        ...
        /// </summary>
        /// <value> The account number of the credit or debit card.   __Min Length:9__&lt;br&gt;  __Max Length:19__ </value>
        ...
        /// </summary>
        /// <value>  The expiry month for the account. Two numeric digits must be supplied.   __Format: MM__&lt;br&gt; __Exact Length:2__ </value>
        ...
        /// </summary>
        /// <value>__(Required as minimum for Tokenization)__  The expiry year for the account. __Format: YY__ &lt;br&gt; __Exact Length:2__ </value>
