...
namespace Acme.App.MastercardApi.Client.Model
{
    ...
    /// TokenDetailPAROnly
    /// </summary>
    [DataContract(Name = "tokenDetail_PAR_Only")]
    public partial class TokenDetailPAROnly : IEquatable<TokenDetailPAROnly>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenDetailPAROnly" /> class.
        /// </summary>
        ...
        /// <param name="iv">It is recommended to supply a random initialization vector when encrypting the data using the one-time use AES key. Must be exactly 16 bytes (32 character hex string) to match the block size. Hex-encoded data (case-insensitive).  __Max Length:32__ .</param>
        /// <param name="encryptedData">encryptedData.</param>
        public TokenDetailPAROnly(string tokenUniqueReference = default(string), string publicKeyFingerprint = default(string), string encryptedKey = default(string), string oaepHashingAlgorithm = default(string), string iv = default(string), TokenDetailDataPAROnly encryptedData = default(TokenDetailDataPAROnly))
        {
        ...
        /// </summary>
        /// <value>It is recommended to supply a random initialization vector when encrypting the data using the one-time use AES key. Must be exactly 16 bytes (32 character hex string) to match the block size. Hex-encoded data (case-insensitive).  __Max Length:32__ </value>
        ...
        public TokenDetailDataPAROnly EncryptedData { get; set; }
        ...
        {
            return this.Equals(input as TokenDetailPAROnly);
        }

        /// <summary>
        /// Returns true if TokenDetailPAROnly instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenDetailPAROnly to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenDetailPAROnly input)
        {
            if (input == null)
                return false;
