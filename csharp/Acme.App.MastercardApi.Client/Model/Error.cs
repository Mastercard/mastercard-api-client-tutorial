...
namespace Acme.App.MastercardApi.Client.Model
{
    ...
    public partial class Error : IValidatableObject
    {
        ...
        /// <param name="errorCode">An error code generated by the gateway if the error occurs before reaching the MDES application. maxLength: 100 .</param>
        ...
        /// </summary>
        /// <value>An error code generated by the gateway if the error occurs before reaching the MDES application. maxLength: 100 </value>
