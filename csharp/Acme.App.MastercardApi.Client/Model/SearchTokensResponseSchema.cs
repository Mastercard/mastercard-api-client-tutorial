...
namespace Acme.App.MastercardApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchTokensResponseSchema")]
    public partial class SearchTokensResponseSchema : IEquatable<SearchTokensResponseSchema>, IValidatableObject
    {
        /// <summary>
        ...
        public SearchTokensResponseSchema(string responseHost = default(string), string responseId = default(string), List<Token> tokens = default(List<Token>))
        {
