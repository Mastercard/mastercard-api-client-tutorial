...
namespace Acme.App.MastercardApi.Client.Model
{
    ...
    public partial class DeleteRequestSchema : IValidatableObject
    {
        ...
        /// <param name="causedBy">Who or what caused the Token to be deleted. Must be either the &#39;CARDHOLDER&#39; (operation requested by the Cardholder) or &#39;TOKEN_REQUESTOR&#39; (operation requested by the token requestor).  (required).</param>
        /// <param name="reason">Free form reason why the Tokens are being suspended. .</param>
        /// <param name="reasonCode">The reason for the action to be deleted. Must be one of &#39;SUSPECTED_FRAUD&#39; (suspected fraudulent token transactions), &#39;OTHER&#39; (Other - default used if value not provided).  (required).</param>
