...
namespace Acme.App.MastercardApi.Client.Model
{
    ...
    public partial class FundingAccountData : IValidatableObject
    {
        ...
        /// <param name="source">(**Required as minimum for Tokenization**) The source of the account. Must be one of   * ACCOUNT_ON_FILE   * ACCOUNT_ADDED_MANUALLY   * ACCOUNT_ADDED_VIA_APPLICATION .</param>
